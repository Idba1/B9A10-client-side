                        ...
                        <div>
                            ...
                            <div className="mt-12 space-y-12">
                                <div className="flex">
                                    ...
                                    <div className="ml-4">
                                        <h4 className="text-lg font-medium leading-6 dark:text-gray-900">Eiffel Tower: </h4>
                                        <p className="mt-2 dark:text-gray-600">Iconic landmark offering stunning views of Paris</p>
                                    </div>
                                </div>
                                <div className="flex">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div className="ml-4">
                                        <h4 className="text-lg font-medium leading-6 dark:text-gray-900">Colosseum: 
                                        </h4>
                                        <p className="mt-2 dark:text-gray-600">Ancient amphitheater showcasing Roman history</p>
                                    </div>
                                </div>
                                <div className="flex">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div className="ml-4">
                                        <h4 className="text-lg font-medium leading-6 dark:text-gray-900">Sagrada Familia: 
                                        </h4>
                                        <p className="mt-2 dark:text-gray-600">Architectural masterpiece by Antoni Gaudi</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="lg:col-start-2">
                                ...
                                <div className="mt-12 space-y-12">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            <h4 className="text-lg font-medium leading-6 dark:text-gray-900">Big Ben: </h4>
                                            <p className="mt-2 dark:text-gray-600">Iconic clock tower in the heart of London
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex">
                                        ...
                                        <div className="ml-4">
                                            <h4 className="text-lg font-medium leading-6 dark:text-gray-900">Keukenhof Gardens: 
                                            </h4>
                                            <p className="mt-2 dark:text-gray-600">World's largest flower garden with vibrant tulip displays</p>
                                        </div>
                                    </div>
                                    <div className="flex">
                                        <div className="flex-shrink-0">
                                        ...
                                        <div className="ml-4">
                                            <h4 className="text-lg font-medium leading-6 dark:text-gray-900">Jungfrau Region:
                                            </h4>
                                            <p className="mt-2 dark:text-gray-600"> Scenic mountain region offering outdoor adventures</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default TouristSpotSctionStatic;